...
class Notepad:
    ...
    def doOpenFile(self):
        ...
        self.CurrFileName = askopenfilename(defaultextension=".txt", filetypes=[
        ...
        if self.CurrFileName == "":  # no file has been selected
            ...
            try:
                ...
                # adjust window title
                self.tkRoot.title(os.path.basename(
                    self.CurrFileName) + " - " + APP_TITLE)
            except:
    ...
    def doSaveFile(self):
        ...
        if self.CurrFileName == None:
            ...
            self.CurrFileName = asksaveasfilename(initialfile='Untitled.txt', defaultextension=".txt", filetypes=[
                                                  ("All Files", "*.*"), ("Text Documents", "*.txt")])
